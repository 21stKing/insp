 ...
 * @author qxf3984
 */
public class HelpWindowCopy extends JFrame implements HyperlinkListener, ActionListener
{
    private String initialURL;
    
    public HelpWindowCopy(String initURL) 
    {           
        ...
        try {
            ...
            Logger.getLogger(HelpWindowCopy.class.getName()).log(Level.SEVERE, null, ex);
        }
        
       
    }

    private HelpWindowCopy() {
   ...
   /** private String setContent(String docPath){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelpWindowCopy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HelpWindowCopy().setVisible(true);
            }
        });
    }
