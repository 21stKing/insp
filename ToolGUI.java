...
public class ToolGUI extends javax.swing.JInternalFrame {
    ...
    public ToolGUI(int idin, int roleIn)
    {   
        id      = idin;
        role    = roleIn;
        logtime = new Date();
        ...
        try
        {
          ...
          data  = database.setToolTable("tool_list");
          data2 = database.setToolListTable("tool_issue_list");
        ...
        toolTable.setModel(new javax.swing.table.DefaultTableModel(data,header));   
        toolListTable.setModel(new javax.swing.table.DefaultTableModel(data2,header2));   
        MainWindow.setActiveTable(toolTable); 
    }
    ...
    private void initComponents() {
        ...
        toolListTable = new javax.swing.JTable();
        ...
        toolTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                toolTableMousePressed(evt);
            }
        });
        jScrollPane1.setViewportView(toolTable);

        toolListTable.setModel(new javax.swing.table.DefaultTableModel(data2,header2));
        toolListTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                toolListTableMousePressed(evt);
            }
        });
        jScrollPane2.setViewportView(toolListTable);

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel2.setText("Issued Tools");
    ...
    private void toolTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_toolTableMousePressed
        
          /* double click on the a row and prompt to issue an item
       if ((evt.getClickCount() == 2) && (!evt.isMetaDown()))
        {
          int row = ToolGUI.this.toolTable.getSelectedRow();
          ...
          try
          {
            ...
            String thisID = (String) ToolGUI.this.toolTable.getValueAt(row, 1);
        ...
        */
    }//GEN-LAST:event_toolTableMousePressed

    private void toolListTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_toolListTableMousePressed
       ...
       if ((evt.getClickCount() == 2) && (!evt.isMetaDown()))
        { 
          ...
          String store_name = "";  
          int thisID = 0;   
          int row = ToolGUI.this.toolListTable.getSelectedRow();
          String issueID   = (String) ToolGUI.this.toolListTable.getValueAt(row, 0);
          String fullname  = (String) ToolGUI.this.toolListTable.getValueAt(row, 1);
          String Companyid = (String) ToolGUI.this.toolListTable.getValueAt(row, 2);
          String itemID    = (String) ToolGUI.this.toolListTable.getValueAt(row, 3);
          String tool   = (String) ToolGUI.this.toolListTable.getValueAt(row, 4);
          String quant     = (String) ToolGUI.this.toolListTable.getValueAt(row, 5);
          String dateout   = (String) ToolGUI.this.toolListTable.getValueAt(row, 6);
          String location  = (String) ToolGUI.this.toolListTable.getValueAt(row, 7);
          String facil     = (String) ToolGUI.this.toolListTable.getValueAt(row, 8);
          String storeman  = (String) ToolGUI.this.toolListTable.getValueAt(row, 9);
          ...
          int answer = JOptionPane.showConfirmDialog(null, "<html>Are you sure you want to receive: <b><i>" + tool+"</i></b> issued to : <html><b><u>"+ fullname+"</u></b></html>", "Receive Confirmation", 0);
               ...
               try
                {
                  ...
                  { 
                      ...
                      else
                      {
                        ...
                        database.setNewToolQuantity(thisID, thisQuant, 1);
                        database.deleteIssuedItem(thisID,"tool_issue_list");
    ...
    }//GEN-LAST:event_toolListTableMousePressed
    ...
    private javax.swing.JTable toolListTable;
